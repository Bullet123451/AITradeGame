...
## 🚀 Getting Started
Follow these steps to download and run AITradeGame.
...
3. **Run the Application**  
   Once downloaded, find the file in your Downloads folder. Double-click the file to run AITradeGame. Follow the on-screen instructions to get started.

### 💻 Features
- **Local Version:** All your data remains on your device. This ensures that your trading history and settings are private.
- **AI-Driven Strategies:** Use powerful AI to simulate trading decisions.
- **Portfolio Management:** Visualize your trades with ECharts integrated dashboards.
- **Trading Fee Configuration:** Adjust settings to mimic real trading costs.

## 🎮 Using AITradeGame
Once you run the application, you can start trading by creating a new account or logging in. The interface is user-friendly and guides you through the process. 

### 🛠️ Settings
- **Configure Trading Fees:** Set fees that you would incur in real-world trading.
- **Select AI Models:** Choose from various AI models to power your trading decisions, such as OpenAI, DeepSeek, and Claude.
